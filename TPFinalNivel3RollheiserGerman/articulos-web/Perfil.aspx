    ...
    <div class="row">
        <div class="col-6">
            ...
            <div class="mb-3">
                ...
                <asp:TextBox ID="txtPass" CssClass="form-control" Required runat="server" MaxLength="20"></asp:TextBox>
            ...
            <div class="mb-3">
                ...
                <asp:TextBox ID="txtPassConfirmar" CssClass="form-control" Required runat="server" MaxLength="20"></asp:TextBox>
        ...
        <div class="col-6">
            <div class="mb-3">
                ...
                <asp:Image ID="imgNuevoPerfil" onerror="this.onload = null; this.src='https://www.pngkey.com/png/full/503-5035055_a-festival-celebrating-tractors-profile-picture-placeholder-round.png';"
                    CssClass="object-fit-contain" ImageUrl="https://www.pngkey.com/png/full/503-5035055_a-festival-celebrating-tractors-profile-picture-placeholder-round.png" Width="100%" Height="460" runat="server" />
            </div>
        </div>
    </div>
</asp:Content>

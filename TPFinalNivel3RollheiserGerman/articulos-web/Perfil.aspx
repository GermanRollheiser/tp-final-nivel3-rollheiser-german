    ...
    <div class="row">
        <div class="col-6">
            ...
            <div class="mb-3">
                ...
                <asp:TextBox ID="txtPass" TextMode="Password" placeholder="Dejar el campo en blanco si no desea modificar el password" CssClass="form-control" runat="server"></asp:TextBox>
            </div>
            <div class="mb-3">
                <label for="txtPassConfirmar" class="form-label">Confirmar password</label>
                <asp:TextBox ID="txtPassConfirmar" TextMode="Password" placeholder="Dejar el campo en blanco si no desea modificar el password" CssClass="form-control" runat="server"></asp:TextBox>
            </div>
            <div class="mb-3">
